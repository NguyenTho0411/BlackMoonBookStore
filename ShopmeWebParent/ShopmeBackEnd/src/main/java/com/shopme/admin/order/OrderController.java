...
public class OrderController {
	...
	public void initBinder(WebDataBinder binder) {
	    NumberFormat format = NumberFormat.getInstance(Locale.US); // Nếu nhập kiểu "1,045.32"
	    binder.registerCustomEditor(Float.class, new CustomNumberEditor(Float.class, format, true));
