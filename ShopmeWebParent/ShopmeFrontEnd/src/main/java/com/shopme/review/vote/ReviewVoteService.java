...
public class ReviewVoteService {
	...
	public void markReviewsVotedForProductByCustomer(List<Review> listReviews, Integer bookId,
			Integer customerId) {
		List<ReviewVote> listVotes = voteRepo.findByProductAndCustomer(bookId, customerId);
